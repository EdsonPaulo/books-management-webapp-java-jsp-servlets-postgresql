...
<html>
    <%
        ...
        try {
            String queryPerson = "SELECT pessoa.pk_pessoa AS id, pessoa.nome AS name, pessoa.sobrenome AS surname, "
                    + "sexo.nome AS gender, pessoa.bi AS bi, pessoa.telefone AS phone, pessoa.email AS email, pessoa.data_nasc AS birthDate, "
    ...
    <body>
        ...
        <a href="<%=request.getContextPath()%>/person-servlet?action=edit&id=<%= id%>" class="btn btn-warning btn-sm mt-4 float-right"> Editar</a>
